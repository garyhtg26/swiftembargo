<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->ISSUING_BANK_HIT == '1') : ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->ADVISING_BANK_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->PORT_OF_LOADING_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->PORT_OF_DISCHARGE_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->PLACE_OF_TAKING_IN_CHARGE_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->PLACE_OF_DESTINATION_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->DESCRIPTION_OF_GOOODS_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->COUNTRY_OF_ORIGIN_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->NOTIFY_PARTY_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->VESSEL_PRE_CARRIAGE_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->VESSEL_MAIN_VESSEL_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->AGENT_OF_CARRIER_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->DELIVERY_AGENT_IN_TRANSPORT_DOC_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->SHIPPING_COMPANY_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->INSURANCE_COMPANY_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->AGENT_OF_INSURANCE_COMPANY_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->SETTLING_AGENT_OF_INSURANCE_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->ISSUER_OF_CERT_OF_ANALYSIS_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->ISSUER_OF_PACKING_LIST_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->ISSUER_OF_HEALTH_CERTIFICATE_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-7 col-form-label">
                ...
                <?php if($post->MANUFACTURER_HIT == '1') : ?>
                <i style="color:red;" class="ml-2 fas fa-exclamation-circle"></i>
                <?php endif; ?>
            </div>
        </div>
